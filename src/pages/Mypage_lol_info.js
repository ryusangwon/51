                                ...
                                <form className="summoner">
                                    ...
                                    <div className="positions">
                                        ...
                                        <div className="position_list">
                                            <input id="top" className="position" type="checkbox"/><div className="position_text">탑</div>
                                            <input id="mid" className="position" type="checkbox"/><div className="position_text">미드</div>
                                            <input id="juggle" className="position" type="checkbox"/><div className="position_text">정글</div>
                                            <input id="adc" className="position" type="checkbox"/><div className="position_text">원딜</div>
                                            <input id="support" className="position" type="checkbox"/><div className="position_text">서포터</div>
                                        </div>
                                    </div>
                                </form>
